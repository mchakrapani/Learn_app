...
class UserprofilesControllerTest < ActionController::TestCase
  ...
  test "should create userprofile" do
    assert_difference('Userprofile.count') do
      post :create, userprofile: { Username: @userprofile.Username, Usertype: @userprofile.Usertype, password: @userprofile.password }
    end
  ...
  test "should update userprofile" do
    put :update, id: @userprofile, userprofile: { Username: @userprofile.Username, Usertype: @userprofile.Usertype, password: @userprofile.password }
    assert_redirected_to userprofile_path(assigns(:userprofile))
  end
